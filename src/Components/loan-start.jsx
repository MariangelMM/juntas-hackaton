    ...
    return (
        <div>
            ...
            <div className="m-5">
                ...
                <h2 className="font-light">Preguntas más frecuentes</h2>

                <div className="accordion acordeon" id="accordionExample">
                    <div className="card">
            ...
            <div className="color-yellow text-center mt-4 font ">
                <h2 className="font pt-4">¿Aún tienes dudas?</h2>
            ...
            <div className="text-center m-5 font">
                <h2 className="font">Ellas Recomiendan Juntas</h2>
